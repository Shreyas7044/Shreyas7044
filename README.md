...
### Books :books:
1. “Continuous Testing for DevOps Professionals”
Author: Arthur Hicken, Gene Kim, Boudewijn van Arem, et al.
2. “Hands-On Test Automation with Python (or Java version)”
Authors: Rahul Shetty / B. Unmesh
3. “The Art of Software Testing” (Fourth Edition)
Author: Glenford J. Myers, Corey Sandler, Tom Badgett

### Blogs :newspaper:
1. Software Testing Help. (STH)
2. QASource Blog.
3. StickyMinds.
